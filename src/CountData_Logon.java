...
private static String fileNameNew;
    ...
    public static void main(String[] args) {
        String path1= "logon2/";
        walk("logon1/" ,path1);
//          String path1= "G:\\开题\\data_new\\logon2\\";
//          walk("G:\\开题\\data_new\\logon1\\" ,path1);
    }
    //写入表头
    ...
    public static void read(String path,String path1){
        try {
            ...
            while ((line1 = reader1.readLine()) != null) {
                ...
                String time1[] = time.split(" ");
                String activity = item[item.length - 3];
                set.add(time1[0]);
                String key=time+ "," +activity;
                map.put(key, str);
            }
